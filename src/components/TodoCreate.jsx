...
const TodoCreate = ({createTodo}) => {
  ...
  return (
        <form onSubmit={handleSubmitAddTodo} className="flex gap-4 bg-white rounded-md items-center py-4 px-4 dark:bg-gray-800 transition-all duration-1000">
            ...
            <input type="text" placeholder="Create a new todo..." className="w-full text-gray-600
            outline-none dark:bg-gray-800 transition-all duration-1000 dark:placeholder:text-gray-500 dark:text-gray-400" value={title}
